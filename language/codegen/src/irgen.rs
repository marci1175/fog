    ...
    'main: 'ctx,
{
    ...
    let created_var = match parsed_token.clone() {
        ...
        ParsedToken::Comparison(lhs, order, rhs, comparison_hand_side_ty) => {
            ...
            let (lhs_val, rhs_val) = set_cmp_mem(
                ctx,
                module,
                builder,
                variable_map,
...
pub fn set_cmp_mem<'ctx>(
    ...
    pointee_ty: common::inkwell::types::BasicTypeEnum<'ctx>,
) -> Result<(BasicValueEnum<'ctx>, BasicValueEnum<'ctx>), common::anyhow::Error>
{
