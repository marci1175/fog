use common::{
    ...
    parser::function::CompilerInstruction,
...
fn try_match_token(string_to_match: &[u8]) -> Option<Token>
{
    Some(match string_to_match {
        ...
        b"exp" => Token::Export,
        b"cold" => Token::CompilerInstruction(CompilerInstruction::Cold),
        b"nofree" => Token::CompilerInstruction(CompilerInstruction::NoFree),
        b"nounwind" => Token::CompilerInstruction(CompilerInstruction::NoUnWind),
        b"inline" => Token::CompilerInstruction(CompilerInstruction::Inline),
        b"feature" => Token::CompilerInstruction(CompilerInstruction::Feature),
        b"." => Token::Dot,
        b":" => Token::Colon,
        b"::" => Token::DoubleColon,
        b"<-" => Token::LeftArrow,
