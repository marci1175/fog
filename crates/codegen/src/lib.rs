...
use fog_common::{
    codegen::{
        ...
        fn_arg_to_string, struct_field_to_ty_list, ty_enum_to_metadata_ty_enum, ty_to_llvm_ty,
    },
                ...
                match ty_disc {
                    ...
                    TypeDiscriminant::Boolean => match desired_type {
                        ...
                        TypeDiscriminant::I32 => {
                            ...
                            let i32_val =
                                builder.build_int_z_extend(val, ctx.i32_type(), "bool_to_i32")?;
                    ...
                    TypeDiscriminant::Array(ref type_discriminant) => match desired_type {
                        TypeDiscriminant::I64 => todo!(),
                        TypeDiscriminant::F64 => todo!(),
                        TypeDiscriminant::U64 => todo!(),
                        TypeDiscriminant::I32 => todo!(),
                ...
                (parsed_lhs, parsed_rhs)
            {
                if l_ty_disc.is_float() && r_ty_disc.is_float() {
                    let math_res = match mathematical_symbol {
                        fog_common::parser::MathematicalSymbol::Addition => builder
                            .build_float_add(
                                builder
                        ...
                        fog_common::parser::MathematicalSymbol::Subtraction => builder
                            .build_float_sub(
                                builder
                                    .build_load(lhs_ty.into_float_type(), lhs_ptr, "lhs")?
                                    .into_float_value(),
                        ...
                        fog_common::parser::MathematicalSymbol::Division => builder
                            .build_float_div(
                                builder
                                    .build_load(lhs_ty.into_float_type(), lhs_ptr, "lhs")?
                                    .into_float_value(),
                        ...
                        fog_common::parser::MathematicalSymbol::Multiplication => builder
                            .build_float_mul(
                                builder
                                    .build_load(lhs_ty.into_float_type(), lhs_ptr, "lhs")?
                                    .into_float_value(),
                        ...
                        fog_common::parser::MathematicalSymbol::Modulo => builder.build_float_rem(
                            builder
                                .build_load(lhs_ty.into_float_type(), lhs_ptr, "lhs")?
                                .into_float_value(),
                            builder
                    ...
                    let math_res = match mathematical_symbol {
                        fog_common::parser::MathematicalSymbol::Addition => builder.build_int_add(
                            builder
                        ...
                        fog_common::parser::MathematicalSymbol::Modulo => builder
